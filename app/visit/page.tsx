  ...
  return (
    <PageTransition>
      <PageHero
        ...
        description="Directions, parking guidance, and what to expect at 20 Overlea Blvd."
        actions={
          <>
      ...
      <Section>
        <MediaBand image={images.about} eyebrow="Arrival" title="Address & what to expect">
          ...
          <div className="flex flex-wrap gap-3 pt-3">
            ...
            <Button href="/get-involved/donate" variant="gold">
              Donate
            </Button>
          </div>
        </MediaBand>
          ...
          <div className="border-l-4 border-ist-gold bg-ist-gold/10 px-6 py-5">
            ...
            <ul className="mt-3 space-y-1.5 text-ist-ink/80">
              <li className="flex items-start gap-2 text-sm">
                <span className="mt-0.5 shrink-0 text-ist-gold" aria-hidden>
                  ✕
                </span>
                <span>
                  <strong>25 Overlea Blvd</strong> — the strip plaza directly across the street
                </span>
              </li>
              <li className="flex items-start gap-2 text-sm">
                <span className="mt-0.5 shrink-0 text-ist-gold" aria-hidden>
                ...
                <span>
                  <strong>East York Town Centre</strong> — the adjacent mall parking lot
                </span>
              </li>
            </ul>
            <p className="mt-3 text-sm text-ist-ink/55">
              Both lots are privately managed and actively enforce — vehicles will be towed at the
              owner&apos;s expense.
            </p>
          </div>
        </FadeUp>
